...
//sysc5404
int decodeOneFrame(DecodedPicList **ppDecPicList, int frameEHB[500][5])
{
    int iRet;
    ...
    //sysc5404
    //*frameNo = pDecoder->p_Vid->frame_no;
    for (int i=0; i<5; i++) {
        frameEHB[pDecoder->p_Vid->frame_no][i] = pDecoder->frameEHB[i];
    }
