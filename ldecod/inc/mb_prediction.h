...
extern void getModeFor4x4(Macroblock *currMB,int img_block_x,int img_block_y,int pm4x4[], int index);
extern int existsMode1(int arr[]);
extern int existsObtuse(int arr[]);
extern void calculate8x8(int pm4x4[], int EHB[]);
extern void makeEHB(int region, int EHB4x4[]);
#endif
